...
namespace Mo7meen
{
    public partial class AddEntsabMoney : Form
    {
        ...
        private void saveButton_Click(object sender, EventArgs e)
        {
            if (paidValue.Text != ""&& custNameText.Text != "" && banksCombo.SelectedItem != null)
            {
                ...
                String sql = "INSERT INTO montsben (client_id,paid_value,paid_date,bank_id,Group_id,details,PaymentType) VALUES (" + clientId + "," + new_value + ",'" + Data + "'," + int.Parse((banksCombo.SelectedItem as ComboBoxItem).value) + "," + GroupId + ",'"+ detailsTxt.Text+ "',0) ";
